...
%(external submitter, consultant, etc.).},
  ...
  extendedabstract={
        ...
        Zároveň sme tak mohli vidieť zrýchlenie pri využítí reálnej produkčnej vzorky, ktorá obsahovala viac než tristo testov a viac než testovacích
        tried sa musela vykonávať s izoláciou.
    },
